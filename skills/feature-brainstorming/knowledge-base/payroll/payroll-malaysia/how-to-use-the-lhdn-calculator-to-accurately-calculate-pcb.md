---
title: "How to Use the LHDN Calculator to Accurately Calculate PCB"
category: "Payroll"
subcategory: "Payroll - Malaysia"
source_url: "https://support.briohr.com/knowledge/how-to-calculate-pcb-using-lhdn-calculator"
date: "August 20, 2026"
---
...
- Go to the website (under the [MyTax Portal](https://mytax.hasil.gov.my/) > Perkhidmatan Ezhasil) **2025 PCB Calculation** calculator: [https://calcpcbplus.hasil.gov.my/HITS_CE/?lang=BM](https://calcpcbplus.hasil.gov.my/HITS_CE/?lang=BM)


**
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Oct-31-2024-04-08-42-4170-AM.png?width=670&height=387&name=image-png-Oct-31-2024-04-08-42-4170-AM.png)
...
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Aug-21-2024-03-25-10-6184-AM.png?width=670&height=465&name=image-png-Aug-21-2024-03-25-10-6184-AM.png)
...
- ***Other accumulated deductions* ***(description of [TP1 Form Note 2024](http://calcpcb.hasil.gov.my/NOTA_PENERANGAN_TP1_2024.pdf))**** ****(if any)*


**
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Oct-31-2024-04-18-27-6999-AM.png?width=670&height=291&name=image-png-Oct-31-2024-04-18-27-6999-AM.png)
...
- ***Deductions (description of [TP1 Form Note 2024](http://calcpcb.hasil.gov.my/NOTA_PENERANGAN_TP1_2024.pdf)) ***under **CURRENT MONTH'S DEDUCTION**.
- ***Rebates ***(e.g., Zakat/Fitrah) under **CURRENT MONTH'S REBATE INFORMATION**.


**
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Oct-31-2024-04-12-25-4948-AM.png?width=670&height=272&name=image-png-Oct-31-2024-04-12-25-4948-AM.png)
...
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Aug-21-2024-03-27-25-3047-AM.png?width=670&height=139&name=image-png-Aug-21-2024-03-27-25-3047-AM.png)
...
- ***Current month's EPF*** under CURRENT MONTH'S REMUNERATION
- ***Additional Remunerations*** **(total income of taxable additional remunerations)** under **CURRENT MONTH'S ADDITIONAL REMUNERATION**
- ***Deductions (from [TP1 Form](http://calcpcb.hasil.gov.my/NOTA_PENERANGAN_TP1_2024.pdf)) ***under **CURRENT MONTH'S DEDUCTION**.
- ***Rebates ***(e.g., Zakat/Fitrah) under **CURRENT MONTH'S REBATE INFORMATION**.
...
If the calculated amount from the LHDN PCB Calculator differs from the amount in BrioHR, download the PDF generated by the calculator and share it with our support team for verification.
