---
title: "Payroll Singapore: How to Set Up Company Payroll General Settings"
category: "Payroll"
...
### Why Setting Up Payroll General Settings is Important


**Setting up payroll for your company in Singapore** is an essential step to ensure smooth and compliant Singapore payroll processing. It also helps automate processes like statutory deductions, salary disbursements, and overtime calculations.


When establishing a new payroll center, one of the most crucial tasks is** setting up the company's general payroll information**. This includes entering the company registration number, bank account details, and configuring salary proration calculations.


This reduces errors in payroll processing and ensures timely salary payments to employees.
...
**
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Mar-27-2026-07-50-26-6719-AM.png?width=670&height=350&name=image-png-Mar-27-2026-07-50-26-6719-AM.png)
**
...
**
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Mar-27-2026-07-51-44-0482-AM.png?width=642&height=331&name=image-png-Mar-27-2026-07-51-44-0482-AM.png)
**


**NOTE:**
**This page must be completed before running the payroll!**


---


### The Payroll Information Page


The page is divided into four (4) sections:
...
**
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Mar-27-2026-07-56-32-8889-AM.png?width=670&height=342&name=image-png-Mar-27-2026-07-56-32-8889-AM.png)
**
...
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Mar-27-2026-02-18-44-7168-PM.png?width=442&height=210&name=image-png-Mar-27-2026-02-18-44-7168-PM.png)
...
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Mar-27-2026-02-34-35-6869-PM.png?width=455&height=249&name=image-png-Mar-27-2026-02-34-35-6869-PM.png)


**CAUTION:**
**It's compulsory to select the relevant statutory bodies. If a statutory body is not selected, it will not be included during a payroll run!**


Example: Your company does have a Chinese employee, but the CDAC is not selected in this setting. The CDAC deduction will not be calculated in the payroll run.
...
**You might see additional fields appear depending on the bank you've chosen. Please fill in all fields accordingly to avoid issues when uploading the bank file to the bank portal.**
...
![image](https://support.briohr.com/hs-fs/hubfs/image-png-Mar-27-2026-02-55-09-3534-PM.png?width=585&height=224&name=image-png-Mar-27-2026-02-55-09-3534-PM.png)


**Explanation:

**If your Overtime and/or Unpaid Leave calculations are based on **basic salary + <additional pay item>**, select the additional pay item here.


**Example:**


If you calculate Overtime/Unpaid Leave by:
...
![image](https://support.briohr.com/hs-fs/hubfs/image-png-May-04-2026-01-37-27-6596-AM.png?width=670&height=162&name=image-png-May-04-2026-01-37-27-6596-AM.png)
...
5. **Click the Save button** once you have completed the updates.


![image](https://support.briohr.com/hs-fs/hubfs/image-png-Mar-27-2026-03-17-10-2655-PM.png?width=670&height=293&name=image-png-Mar-27-2026-03-17-10-2655-PM.png)
...
3. Why is the wrong bank file generated?
**Ensure you select the correct bank that your company uses for salary payment.
