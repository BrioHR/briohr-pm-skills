...
> "Want me to adjust any section, add more scenarios, post these as a comment on the Jira ticket, or export them as a Markdown file?"
...
- If the PM asks to export, generate the test cases as a downloadable **Markdown (`.md`) file** they can share or attach.
