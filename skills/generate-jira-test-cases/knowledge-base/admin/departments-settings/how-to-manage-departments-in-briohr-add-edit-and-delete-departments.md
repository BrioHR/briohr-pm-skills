---
title: "How to Manage Departments in BrioHR: Add, Edit, and Delete Departments"
category: "Admin"
...
### Why Managing Departments Is Important


Organizing employees into the correct departments helps HR Teams:


- Improve reporting and analytics accuracy.
- Manage department-specific permissions and responsibilities.
...
Assigning a Head of Department is useful for **the approval flows process** in the **Training Management Module.** Learn more in:
...
1. On the **Departments** page, locate the department you wish to update (*e.g., Human Resources*).
...
You cannot **delete a departmen**t if **employees are still assigned** to it.
...
- **Unable to Delete Department**
  ...
  - Ensure no employees are assigned to the department before attempting to delete it.
...
- [How to Manage Job Titles in BrioHR: Add, Edit, or Delete Job Titles](https://support.briohr.com/knowledge/how-to-add-edit-or-delete-job-titles?hsLang=en)
...
**Q1: What happens if I rename a department?
A: **The change will automatically update across all employee profiles linked to that department.


**Q2: Can I assign multiple Heads of Department in BrioHR?**
A: No, only one Head of Department can be assigned per department.


**Q3: Can I restore a deleted department?**
A: No, once a department is deleted, it cannot be restored. You will need to create it again manually.
