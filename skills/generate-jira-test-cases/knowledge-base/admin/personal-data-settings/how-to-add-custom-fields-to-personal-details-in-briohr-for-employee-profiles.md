---
title: "How to Add Custom Fields to Personal Details in BrioHR for Employee Profiles"
category: "Admin"
...
*This article explains how to add custom fields, such as a confirmation date, to the Personal Details of employee profiles.*

You can create as many custom fields as you need under Personal Details. In this example, we'll add "Confirmation Date" to an employee's Personal Details. All custom fields created will appear on the **Employees' My Profile** page.
...
- Navigate to **Settings **at the top right corner of the Home page.


- Go to **Personal Data.**
- Ensure you are on the **Personal Details **page.
...
- Enter a name for your new field item.
- Choose from **four types of fields**:
...
#### Editing and Viewing Custom Fields
