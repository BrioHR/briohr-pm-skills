...
A user is considered **INACTIVE** if their **employment end date has passed**. The employment end date has to be entered in the employee profile.


Refer to the article below on how to enter the employment end date and check for inactive employees -


**Learn more: [How to Deactivate or Remove a Resigned Employee's Account in BrioHR](/knowledge/how-to-deactivate-or-remove-a-resigned-employees-account-in-briohr?hsLang=en) **
