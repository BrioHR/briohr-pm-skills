---
title: "How to Clock Out and Clock In for Breaks in BrioHR (Browser Guide)"
category: "Employee"
...
*Learn how to accurately clock out and clock in for breaks with BrioHR Web Browser. Follow these simple steps to ensure your work hours are recorded correctly.*

### Introduction


Employees who clock in at the start of the day must **clock out before going on their break**. This ensures the system correctly records break duration, which will be deducted from the total working hours.


When employees **resume work after a break**, they must clock back in. This allows the system to accurately capture the time spent on break and reflect it in the **attendance timesheet**.


**Related Guides:**


- [How to Clock In and Clock Out Using BrioHR (Browser Guide)](https://support.briohr.com/knowledge/how-to-clock-in-and-out-using-briohr-browser?hsLang=en)
- [How to Clock In Using BrioHR Mobile App](https://support.briohr.com/knowledge/how-to-clock-in-using-briohr-mobile-app?hsLang=en)


---


### Steps to Clock Out Before a Break


#### Step 1 - Find the Clock Out Section


1. Login to your BrioHR account > Go to **Home Page.**


2. Locate the **Clock Out** section.
...
#### Step 2 - Start Clocking Out Before Break
...
- **Time:** Your current clock-out time.
- **When:** The corresponding clock-out date.
- **Note:** An optional field where you can add a note or comment before clocking out.


3. Click **Take Break **to confirm and proceed.


**CAUTION:**


Do **not **click the** Final Clock Out **button when taking a break. The Final Clock Out is only for **ending your workday.**


Clicking it will generate your daily attendance timesheet and make your workday as completed.
...
### Steps to Clock In After a Break


#### Step 1 - Resume Work


1. After your break, return to the **Clock Out** section.
...
#### Step 2 - Confirm Clock-in


1. A confirmation sidebar will appear.


2. Click the **Clock In** button to proceed.


![image](https://support.briohr.com/hs-fs/hubfs/image-png-Aug-21-2025-09-28-25-9623-AM.png?width=412&height=502&name=image-png-Aug-21-2025-09-28-25-9623-AM.png)
...
**Q1: Why do I need to clock out before going on break, and clock in after?**


**A: **Clocking out and in ensures the system records the correct break duration. This prevents break time from being counted as working hours or overtime.
...
Make sure you only click **Take Break** when pausing for a break.
